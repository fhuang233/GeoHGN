# Based on the code from: https://github.com/divelab/DIG/blob/dig-stable/dig/threedgraph/method/comenet/features.py
...
def dist_emb(D, D_min=0., D_max=20., D_count=16, device='cpu'):
    '''
...
class sphe_emb(torch.nn.Module):
    def __init__(self, num_radial, num_spherical, cutoff=8.0):
        super(sphe_emb, self).__init__()
        assert num_radial <= 64
        self.num_radial = num_radial
        self.num_spherical = num_spherical
        self.cutoff = cutoff
